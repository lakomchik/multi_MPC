...
namespace MPC
{
    ...
    Eigen::DiagonalMatrix <autodiff::real, 3> const R (0.3, 0.3, 0.1);
    ...
    class MPC
    {
        ...
        public:
        void euler_integration(Eigen::Matrix<autodiff::real, n_states, 1> const & curr_pos, Eigen::Matrix<autodiff::real, n_controls, 1> const & curr_controls,
        ...
        void set_init_cond (Eigen::Matrix<autodiff::real, n_states, 1> const & init_cond);
        ...
        void set_reference(const Eigen::Matrix<autodiff::real, n_states, N>& ref_path, const Eigen::Matrix<autodiff::real, n_controls, N> & ref_con);
        void init_nlopt();
        ...
        Eigen::Matrix<double, n_states, 1> solve(Eigen::Matrix<double, 3, 1> init_cond, double & minf);
        Eigen::Matrix<double, n_states, 1> solve(Eigen::Matrix<double, 3, 1> init_cond, std::vector<double> & predicted_states);

...
file_name = ("omni_coeffs 20.00 20.00 20.00 0.50 0.50 0.10.txt")
...
plot1.plot(mpc_coords[:iter_num,0],mpc_coords[:iter_num,1],"r--",linewidth=3.5, label = "MPC controller")
...
plot2.plot(time,mpc_coords[:iter_num,2],"r--", linewidth = 3.5, label = "Real \u03F4")
plot2.legend()
